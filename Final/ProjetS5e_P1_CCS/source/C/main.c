...
/*
  Créateur:    Team P1
  DESCRIPTION : 
     Code principal pour détection de voix

  ENTRÉES : 
	 Il y a deux types d'entrées  :
     1) Signal audio branché sur l'entrée MIC du DSK.
     2) Les caractères envoyés par le PIC.

  SORTIES : 
     1) Caractères & id utilisateurs envoyés au PIC
